...
{{--                                    <th class="text-center">SL</th>--}}
                                ...
                                @if ($allData->count() > 0)
                                    ...
                                    @php
                                        $c = 1;
                                          function formatCategories($categories, $parent){
                                                $menu2 = [];
                                        ...
                                        function menuTable($parent_menu, $parent,$line='&nbsp &nbsp - '){
                                            $parent_menus = formatCategories($parent_menu, $parent);
                                            foreach($parent_menus as $key=>$data){
                                               ...
                                               echo '<tr>
                                                        <td><a href="'.url('inventory/categories/'.$data->id).'/edit">'.$line. $data->name.'</a></td>
                                                        <td class="text-center">'.$status.'</td>
                                                        <td class="text-center">
                                                           <div class="btn-group">
                                                               <button type="button" class="btn btn-outline-info">
                                                                <a href="'.url('inventory/categories/'.$data->id).'/edit"><i class="fa fa-edit"></i> </a>
                                                                </button>
                                                                <button type="button" class="btn btn-outline-info">
                                                                <a data-toggle="modal" data-target="#windowmodal" href="'.url('inventory/categories/delete/'.$data->id).'"><i class="fa fa-trash"></i> </a>
                                                                </button>
                                                        </div>
                                                        </td>
                                                    </tr>';

                                           menuTable($parent_menu, $data->id,'&nbsp &nbsp'.$line.'- ');
                                        }
                                    }
                                    @endphp
...
{{--                                            <td class="text-center">{{ $c+$serial }}</td>--}}
                                            <td> <a href="{{url($bUrl.'/'.$data->id.'/edit')}}">{{ $data->name }} </a></td>
                                            <td class="text-center">{!! $status !!}</td>
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-outline-info">
